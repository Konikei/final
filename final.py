...
def submitWindow():
    ...
    newWindow = tk.Tk()
    newWindow.title('Submit Form')
    newWindow.geometry('215x100+25+0')
    newWindow.configure(background='dark blue')
    newWindow.resizable(False, False)
    
    #buttons
    exit_button= tk.Button(newWindow, text= 'Exit', command=newWindow.destroy)
    labelOne=tk.Label(newWindow, text='Thank you for ordering with us. ', bg='light blue')
    labelTwo=tk.Label(newWindow, text=' Your delicious desert will be ready soon', bg='light blue')
